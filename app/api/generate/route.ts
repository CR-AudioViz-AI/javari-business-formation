// app/api/generate/route.ts — javari-business-formation
...
const SYSTEM           = `You are a business formation expert. Help entrepreneurs create LLCs, corporations, and business structures. Provide complete formation guides, operating agreements, EIN applications, and state-specific requirements.`
const ACTIONS          = ["llc_formation", "corporation_setup", "operating_agreement", "ein_application", "business_plan", "registered_agent"]
